#include "../../../include/world/prototypes/floor_end_room.h"

void floorEndRoomInit(Room* _self) {
    _self->type = FLOOR_END_ROOM;
...
void floorEndRoomRender(Room* _self, void* _world) {
    ...
    placeTile(_world, TILE_BACKGROUND_SCREEN_BLOCK, newIVec2(7, 4), DOOR_UP_OPENED, NEXT_FLOOR_ENTRANCE);
}
