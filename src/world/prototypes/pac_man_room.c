#include "../../../include/world/prototypes/pac_man_room.h"

void pacmanRoomInit(Room* _self) {
    _self->type = PAC_MAN_ROOM;
    ...
    tryPushEntityToRoom(_self, _SKELETON_ANCIENT_ENTITY_(16, 80));
    tryPushEntityToRoom(_self, _SKELETON_ANCIENT_ENTITY_(208, 80));

    tryPushEntityToRoom(_self, _SKELETON_NINJA_ENTITY_(96, 80));
    tryPushEntityToRoom(_self, _SKELETON_NINJA_ENTITY_(112, 80));
    tryPushEntityToRoom(_self, _SKELETON_NINJA_ENTITY_(128, 80));

    tryPushLightToRoom(_self, (ivec2){.x = 112, .y = 0});
    tryPushLightToRoom(_self, (ivec2){.x = 48, .y = 112});
    tryPushLightToRoom(_self, (ivec2){.x = 176, .y = 112});
}
...
void pacmanRoomRender(Room* _self, void* _world) {
    ...
    placeTile(_world, TILE_BACKGROUND_SCREEN_BLOCK, newIVec2(3,  1), BORDER_UP, WALL);
    placeTile(_world, TILE_BACKGROUND_SCREEN_BLOCK, newIVec2(11, 1), BORDER_UP, WALL);
    ...
    placeTile(_world, TILE_BACKGROUND_SCREEN_BLOCK, newIVec2(3,  7), TORCH_TILE, NONE);
    placeTile(_world, TILE_BACKGROUND_SCREEN_BLOCK, newIVec2(11, 7), TORCH_TILE, NONE);
}
