...
#define _SOUND_1_FREQ_  ((vu16 *) 0x0400064)

//Sound 1 Lenght, wave duty and envelope control
#define _SOUND_1_CONTROL_ ((vu16 *) 0x0400062)

//Sound 1 Sweep control
#define _SOUND_1_SWEEP_ ((vu16 *) 0x0400060)
...
#define _SOUND_DMG_CONTROL_ ((vu8 *) 0x0400080)
