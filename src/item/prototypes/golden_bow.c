#include "../../../include/item/prototypes/golden_bow.h"

void goldenBowUseCallback(Entity* _use_target, Room* _active_room) {
    log(LOG_INFO, "Used golden bow");
    ...
    */
    ...
    i32 sprite_offset_horizontal = 584;
    i32 sprite_offset_vetical = 728;
