#include "../../../include/item/prototypes/ice_staff.h"

void iceStaffUseCallback(Entity* _use_target, Room* _active_room) {
    log(LOG_INFO, "Used ice staff");
    ...
    */
    ...
    i32 sprite_offset_horizontal = 560;
    i32 sprite_offset_vetical = 704;
